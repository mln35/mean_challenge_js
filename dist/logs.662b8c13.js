...
})({"3gagN":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "7a7c4ed6662b8c13";
"use strict";
...
addLog = ()=>{
    ...
    _logStorageDefault.default.saveLog(date, code_debit, code_credit, label_debit, label_credit, amount_debit_debit, amount_debit_credit, amount_credit_debit, amount_credit_credit, object);
    renderTransactions();
};
clearJournal = ()=>{
    _logStorageDefault.default.clearTransactions();
    renderTransactions();
};
initView = ()=>{
...
exports.saveLog = (_date, _code_deb, _code_cred, _label_deb, _label_cred, _amount_debit_debit, _amount_debit_credit, _amount_credit_debit, _amount_credit_credit, _object)=>{
...
exports.clearTransactions = ()=>{
    ...
    for(let i = 0; i < count; i++)localStorage.removeItem(t_key + i);
    localStorage.removeItem(count_key);
};

},{}],"eQa2e":[function(require,module,exports) {
...
//# sourceMappingURL=logs.662b8c13.js.map
